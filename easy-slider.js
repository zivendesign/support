...
$.fn.easySlider = function(o) {
    ...
    return this.each(function() {                           // Returns the element collection. Chainable.
        ...
        var running = false, animCss=o.vertical?"top":"left", sizeCss=o.vertical?"width":"height";
        ...
        ul.css({width: li.width(), height: li.height()}).css(sizeCss, ulSize+"px").css(animCss, -(curr*liSize));
        ...
        function adjust(){
            if (o.vertical){
                //check top position
                liTop= Math.abs(li.eq(active).position().top);
                ulTop= Math.abs(ul.position().top);
                if (liTop<ulTop){
                    if (o.animate)
                        ul.stop(true).animate({"top":-liTop},o.speed);
                    else
                        ul.css("top",-liTop);
                }else{
                    //check right position
                    a= liTop + li.eq(active).outerHeight( true );
                    b= div.height()+ulTop;
                    if (a>b){
                        ulTop+=a-b;
                        if (o.animate)
                            ul.stop(true).animate({"top":-ulTop},o.speed);
                        else
                            ul.css("top",-ulTop);
                    }
                }
